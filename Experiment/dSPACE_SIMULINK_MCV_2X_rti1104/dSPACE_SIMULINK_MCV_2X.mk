...
#
#  $RCSfile: dSPACE_SIMULINK_MCV_2X.mk $ $Revision: 2.40 $ $Date: 2010/06/17 13:44:29CEST $
...
MAKEFILE                       = dSPACE_SIMULINK_MCV_2X.mk
...
MATLAB_ROOT_ALT                = C:\PROGRA~1\MATLAB\R2010b
MATLAB_BIN_ALT                 = C:\PROGRA~1\MATLAB\R2010b\bin
RELEASE_VERSION                = R2010b
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN
MODEL                          = dSPACE_SIMULINK_MCV_2X
MODULES                        = dSPACE_SIMULINK_MCV_2X_data.c dSPACE_SIMULINK_MCV_2X_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = C:\Users\Team10\Desktop\Firdous\SYSTEM~1\OUTPUT~2\MCVCON~1
# Shared library for utility code
RTW_SHARED_LIB_SRCS_WILD       = 
RTW_SHARED_LIB_SRCS_DIR        = 
RTW_SHARED_LIB_OBJS_DIR        = 
RTW_SHARED_LIB                 = 
RTW_MODELLIB                   = dSPACE_SIMULINK_MCV_2Xlib.lib
...
RTWCUST_INCLUDES = \
	$(START_DIR)\dSPACE_SIMULINK_MCV_2X_rti1104 \
	$(START_DIR)

/************************ dSPACE target specific file *************************
   ...
   Include file .\dspace_simulink_mcv_2x_rti1104\dSPACE_SIMULINK_MCV_2X_th.c :

   Task Configuration file for model : dSPACE_SIMULINK_MCV_2X

   RTI1104 6.6 (29-Nov-2010)/2.3
   08-Oct-2013 20:27:22
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\dspace_simulink_mcv_2x_rti1104\dSPACE_SIMULINK_MCV_2X_th.c is for ST).
# endif
